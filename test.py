...
# sns.histplot(data["Power1"], kde=True, stat="density")
# plt.show()
...
# scaler = MinMaxScaler()                         # defaults to range [0, 1]
# scaler.fit(dataset)                             # compute the scaling factors
# MinMaxScaler(copy=True, feature_range=(0, 1))
# scaled_data = scaler.transform(dataset)         # scale the data

# scaled_data.shape                               # still the same shape
# print(dataset)
